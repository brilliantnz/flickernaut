...
export class ApplicationListClass extends Adw.ExpanderRow {
  ...
  declare private _app_Id: string;
  declare private _name: Adw.EntryRow;
  declare private _icon: string;
  declare private _pinned: boolean;
  declare private _multiple_files: Adw.SwitchRow;
  declare private _multiple_folders: Adw.SwitchRow;
  declare private _packageType: "Flatpak" | "AppImage" | "Native";
  declare private _mime_types: Adw.EntryRow;
  declare private _pin_button: Gtk.Button;
  declare private _toggleSwitch: ToggleSwitchClass;
  declare private _remove_app_button: Gtk.Button;
