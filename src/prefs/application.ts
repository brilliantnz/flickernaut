...
export const ApplicationPage = GObject.registerClass(
  {
    ...
    InternalChildren: ["banner", "app_group", "add_app_button"],
  },
  class extends Adw.PreferencesPage {
    declare private _banner: Adw.Banner;
    declare private _app_group: Adw.PreferencesGroup;
    declare private _add_app_button: Gtk.Button;
    declare private _settings: Gio.Settings;
    declare private _bannerHandler: BannerHandler;
    declare private _applicationsList: Application[];
    declare private _applicationsListUi: Application[];
    declare private _applications: { Row: Adw.ExpanderRow }[];
    ...
    private _refreshWidgets() {
      ...
      this._applicationsList.sort((a, b) =>
        ...
        if (this._applicationsList.length > 0) {
          ...
          for (const app of this._applicationsList) {
            try {
              ...
              if (!this._applications) this._applications = [];
